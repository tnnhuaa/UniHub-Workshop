...
const workshopImages = {
  studentProfile: '/figma-mcp/22492359-f12d-464a-b95a-fb292c891cc8.jpg',
  speaker: '/figma-mcp/2ee92fe2-f247-4654-8897-051b1d405acb.jpg',
  reactSpeaker: '/figma-mcp/d068b264-bedc-481e-99ad-9b6f92676680.jpg',
  ...
  profileAvatar: '/figma-mcp/8b5490f6-451d-4c0e-b17e-9b43a0619761.jpg',
  strategyWorkshop: '/figma-mcp/9b0e9b49-856f-47e4-9ac5-2de62892ba6e.jpg',
  pythonWorkshop: '/figma-mcp/64a58b45-b300-48f9-995e-2293793f2b53.jpg',
  designWorkshop: '/figma-mcp/0847573c-09b5-4b5f-99f0-8cc62fb92523.jpg',
  qrCode: '/figma-mcp/5c679e98-021a-4ac3-a67b-e57df7f69bfb.jpg',
  instructor: '/figma-mcp/2b82168d-29d3-4c5e-9069-76b377aabbc7.jpg',
};
...
const mockWorkshops: MockWorkshopDetail[] = [
  ...
  },
  {
    ...
    floorMapImage: workshopImages.mapLocation,
    speakerBio:
      'Michael teaches applied analytics with a focus on practical tooling.',
  },
  {
    ...
    floorMapImage: workshopImages.mapLocation,
    speakerBio:
      'Emma supports students in study planning and academic sustainability.',
  },
  {
  ...
  },
  {
    ...
    floorMapImage: workshopImages.mapLocation,
    speakerBio:
      'Elena frequently mentors technical teams on emerging technologies.',
  },
];
...
const filterWorkshops = (query: MockWorkshopQuery) => {
  ...
  const startFrom = query.startFrom
    ? normalizeDate(query.startFrom)
    : undefined;
  ...
  return mockWorkshops.filter((workshop) => {
    ...
    if (
      q &&
      ![workshop.title, workshop.description, workshop.speaker, workshop.room]
        .join(' ')
        .toLowerCase()
        .includes(q)
    ) {
...
const performMockRequest = async <TData, TBody = undefined>(
  ...
  if (method === 'GET' && path === '/workshops') {
    return {
      ...
      data: filterWorkshops(
        (options?.query ?? {}) as MockWorkshopQuery,
      ) as TData,
      request,
    };
  }
  ...
  if (method === 'GET' && path === '/registrations/me') {
    const requestedStatus = options?.query?.status as
      | RegistrationStatus
      | undefined;
...
export const updateMockStudentProfile = (
  ...
  performMockRequest<MockStudentProfile, MockProfileUpdatePayload>(
    'PUT',
    `/students/${mssv}`,
    { body: payload },
  );
...
export const createMockRegistration = (payload: MockRegistrationPayload) =>
  performMockRequest<MockRegistration, MockRegistrationPayload>(
    'POST',
    '/registrations',
    { body: payload },
  );
...
export const getMockRegistrationQr = (registrationId: string) =>
  performMockRequest<MockQrCodeResponse>(
    'GET',
...
export const deleteMockRegistration = (registrationId: string) =>
  performMockRequest<{ id: string; status: 'cancelled' }>(
    'DELETE',
...
export const postMockAuth = <TBody extends Record<string, unknown>>(
  ...
  performMockRequest<{ user: { email: string; role: string } }, TBody>(
    'POST',
    path,
    { body: payload },
  );
