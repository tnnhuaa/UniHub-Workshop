...
const FUTURE_WORKSHOPS = [
  {
    id: '81000001-a821-4f01-8a01-260814000001',
    title: 'Git & Collaborative Workflows',
    description:
      'Practice branching, pull requests, code reviews, and conflict resolution.',
    speaker: 'Nguyen Hoai Nam',
    room: 'Lab 2',
    capacity: 45,
    registeredCount: 0,
    price: 0,
    startTime: new Date('2026-08-14T02:00:00Z'),
    endTime: new Date('2026-08-14T04:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: '81000002-a822-4f02-9a02-260822000002',
    title: 'REST API Design with NestJS',
    description: 'Design validated, secure, and maintainable APIs with NestJS.',
    speaker: 'Tran Duc Khoa',
    room: 'A305',
    capacity: 50,
    registeredCount: 0,
    price: 30000,
    startTime: new Date('2026-08-22T06:30:00Z'),
    endTime: new Date('2026-08-22T09:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: '81000003-a829-4f03-aa03-260829000003',
    title: 'UI Accessibility Lab',
    description:
      'Improve keyboard navigation, semantic HTML, and screen-reader support.',
    speaker: 'Le Minh Thu',
    ...
    endTime: new Date('2026-08-29T04:30:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: '91000001-b905-4f04-8b04-260905000004',
    title: 'PostgreSQL Query Optimization',
    description:
      'Use indexes and query plans to diagnose and improve database performance.',
    speaker: 'Pham Quang Huy',
    room: 'C203',
    capacity: 40,
    registeredCount: 0,
    price: 50000,
    startTime: new Date('2026-09-05T02:00:00Z'),
    endTime: new Date('2026-09-05T05:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: '91000002-b916-4f05-9b05-260916000005',
    title: 'Building Reliable Payment Flows',
    description:
      'Explore idempotency, transaction boundaries, retries, and payment states.',
    speaker: 'Vo Thanh Tung',
    room: 'B304',
    capacity: 55,
    registeredCount: 0,
    price: 75000,
    startTime: new Date('2026-09-16T06:00:00Z'),
    endTime: new Date('2026-09-16T09:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: '91000003-b926-4f06-ab06-260926000006',
    title: 'Career Portfolio Demo Day',
    description:
      'Present a technical project and receive feedback from engineers and peers.',
    speaker: 'NAB Alumni Network',
    room: 'Innovation Hall',
    capacity: 100,
    registeredCount: 0,
    price: 0,
    startTime: new Date('2026-09-26T01:30:00Z'),
    endTime: new Date('2026-09-26T04:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'a1000001-c007-4f07-8c07-261007000007',
    title: 'Cloud Deployment with Docker',
    description:
      'Package and deploy a web application using containers and cloud services.',
    speaker: 'Do Gia Long',
    room: 'Cloud Lab',
    capacity: 40,
    registeredCount: 0,
    ...
    endTime: new Date('2026-10-07T05:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'a1000002-c017-4f08-9c08-261017000008',
    title: 'Automated Testing for Web Apps',
    description:
      'Build unit, integration, and end-to-end tests for modern web applications.',
    speaker: 'Bui Ngoc Anh',
    room: 'A404',
    capacity: 45,
    registeredCount: 0,
    price: 0,
    startTime: new Date('2026-10-17T06:00:00Z'),
    endTime: new Date('2026-10-17T09:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'a1000003-c028-4f09-ac09-261028000009',
    title: 'AI Product Prototyping',
    description:
      'Turn an AI product idea into a testable prototype with responsible design.',
    speaker: 'Nguyen Bao Tram',
    room: 'Innovation Studio',
    capacity: 60,
    registeredCount: 0,
    price: 40000,
    startTime: new Date('2026-10-28T02:00:00Z'),
    endTime: new Date('2026-10-28T04:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'b1000001-d106-4f10-8d10-261106000010',
    title: 'System Design for Student Projects',
    description:
      'Model services, databases, queues, and failure scenarios for scalable systems.',
    speaker: 'Le Anh Quan',
    room: 'B201',
    capacity: 50,
    registeredCount: 0,
    price: 50000,
    startTime: new Date('2026-11-06T02:00:00Z'),
    endTime: new Date('2026-11-06T05:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'b1000002-d116-4f11-9d11-261116000011',
    title: 'Technical Interview Practice',
    description:
      'Practice coding, debugging, and behavioral interview questions in pairs.',
    speaker: 'University Career Center',
    room: 'Career Hub',
    capacity: 70,
    registeredCount: 0,
    price: 0,
    startTime: new Date('2026-11-16T06:00:00Z'),
    endTime: new Date('2026-11-16T08:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
  {
    id: 'b1000003-d127-4f12-ad12-261127000012',
    title: 'Open Source Contribution Sprint',
    description:
      'Find an issue, prepare a focused change, and submit a high-quality pull request.',
    speaker: 'UniHub Engineering Club',
    room: 'Lab 5',
    capacity: 50,
    registeredCount: 0,
    price: 0,
    startTime: new Date('2026-11-27T01:00:00Z'),
    endTime: new Date('2026-11-27T04:00:00Z'),
    status: 'published',
    floorMapUrl: null,
  },
];

WORKSHOPS.push(...MORE_WORKSHOPS, ...FUTURE_WORKSHOPS);
